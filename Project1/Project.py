...
class Main(tk.Frame):
    ...
    def init_main(self):
        # создание панели инструментов, где bg - фон, bd - границы
        toolbar = tk.Frame(bg='#d7d8e0', bd=2)
        # side закрепляет объект вверху окна, а fill растягивает по Х
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        # добавление строки ввода для имени
        ...
        # добавление строки ввода для телефона
        ...
        self.btn_ok.bind('<Button-1>', lambda event: self.view.records(self.entry_name.get(), self.entry_email.get(), self.entry_tel.get()))
